...
public class UserDetailsInDAS implements UserDetails {
	...
	public UserDetailsInDAS(Integer id, String username, String email, String password,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UserDetailsInDAS other = (UserDetailsInDAS) obj;
		if (id != other.id)
			return false;
		return true;
	}
